...
urlpatterns = [
    ...
    url(r'^about/$','article.views.home',name="about"),
    url(r'^message/$','article.views.home',name="message"),
    url(r'^archive/$','article.views.home',name="archive"),
    url(r'^feed/$', 'article.views.home', name = "RSS"),
